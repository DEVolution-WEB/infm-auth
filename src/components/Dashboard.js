...
const Dashboard = () => {
	...
	return (
		<div>
			<header class=''>
				<nav class='flex items-center justify-between p-6 h-24 bg-white shadow-sm bg-opacity-70 fixed inset-x-0 z-40 backdrop-filter backdrop-blur'>
					{' '}
					...
					<ul>
						<li class='space-x-3 text-lg text-darkBlueCust'>
							<a href='https://www.infm.fr/#section-a836c60-o' class='py-2 px-3 hover:bg-darkBlueCust hover:text-white rounded-3xl transition duration-300'>
								Notre mission
							</a>
							<a href='https://www.infm.fr/#section-2f18e25-o' class='py-2 px-3 hover:bg-darkBlueCust hover:text-white rounded-3xl transition duration-300'>
								Nos formations
							</a>
							<a href='https://www.infm.fr/#section-6bb4f66-o' class='py-2 px-3 hover:bg-darkBlueCust hover:text-white rounded-3xl transition duration-300'>
								Le fondateur
							</a>
							<a href='https://www.infm.fr/#section-8cf797d-o' class='py-2 px-3 hover:bg-darkBlueCust hover:text-white rounded-3xl transition duration-300'>
								Quelques chiffres
							</a>
							<a href='https://www.infm.fr/#section-c1b9ad3-o' class='py-2 px-3 hover:bg-darkBlueCust hover:text-white rounded-3xl transition duration-300'>
								Témoignages
							</a>
							<a href='https://www.infm.fr/#section-71bd491-o' class='py-2 px-3 hover:bg-darkBlueCust hover:text-white rounded-3xl transition duration-300'>
								Plan d'accès
							</a>
							<button onClick={goToSection} class='py-2 px-3 hover:bg-blue-900 hover:text-white rounded-3xl transition duration-300'>
								Contact
							</button>
							<a href='https://www.infm.fr/#' class='py-3 px-3 bg-darkBlueCust hover:bg-blue-700 text-white hover:text-yellowCust rounded-3xl transition duration-300'>
								Se déconnecter
							</a>
						</li>
					</ul>
				...
				<div class='bg-white py-12 px-10'>
					<div>
						...
						<div className='w-full max-w-screen-lg m-auto bg-white rounded-lg border border-primaryBorder shadow-default py-5 px-16'>
							{admin ? <CreateUser /> : <Userpage currentUser={currentUser} />}
							<div className=' flex flex-col justify-around mt-2 mb-0'>
								<button className='bg-blue my-8 py-2 px-4 text-sm text-white rounded border border-blue-light focus:outline-none focus:border-primary hover:bg-blue-light' onClick={handleLogout}>
									Se déconnecter
								</button>
								{admin && <Link to='./update-profile'>Modifier les identifiant de connexion </Link>}
							</div>
						</div>
					</div>
				</div>
