	...
	return (
		<div>
			...
			<ul>
				...
				<li className={`${hasNumber ? 'text-green-500' : 'text-gray-400'}`}>1 chiffre</li>
				<li className={`${upperCase ? 'text-green-500' : 'text-gray-400'}`}>1 lettre majuscule</li>
				<li className={`${lowerCase ? 'text-green-500' : 'text-gray-400'}`}>1 lettre minuscule</li>
